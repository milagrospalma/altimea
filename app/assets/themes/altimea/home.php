...
<header class="header">
    <div class="container">
        <h1 class="logo"> <a class="blogo" href="<?php echo get_site_url().'/blog/' ?>">BLOG </a>
        ...
        <div class="valores">
            <div class="valores-in">TECNOLOGÍA</div>
            <span class="slashy">/</span>
            <div class="valores-in">ACTUALIDAD</div>
            <span class="slashy">/</span>
            <div class="valores-in">PROYECTOS</div>
        </div>
                                    ...
                                    <header class="entry-header">
                                        ...
                                        <div class="post-header">
                                            <?php if(!empty(get_the_category())){ ?>
                                                <span class="cat-links"> <a href="<?php  echo get_site_url().'/category/'.get_the_category()[0]->slug.'/'; ?>" title="View all posts in Design" rel="category tag"><?php echo get_the_category()[0]->name; ?></a></span>
                                            <?php } ?>
